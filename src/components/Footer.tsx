...
const Footer: FunctionComponent<FooterType> = ({
  ...
  return (
    <div
      className={`w-[1596px] flex flex-col items-start justify-start gap-20 max-w-full text-left text-lg text-black font-alegreya mq900:gap-10 mq450:gap-5 ${className}`}
      style={footerStyle}
    >
      <img
      ...
      <div className="self-stretch flex flex-col items-center justify-start pt-0 px-0 pb-0 box-border gap-[45px] max-w-full shrink-0 mq900:gap-[22px]">
        <div className="relative inline-block max-w-full">
          copyright@2023 Lal kitab All Right Reserved
        </div>
        <img
