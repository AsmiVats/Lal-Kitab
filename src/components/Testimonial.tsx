...
const Testimonial: FunctionComponent<TestimonialType> = ({
  ...
  return (
    ...
    >
      <div className="self-stretch flex flex-col items-start justify-start gap-[10px] max-w-full mq900:gap-[27px]">
        <h1 className="m-0 self-stretch  relative text-inherit leading-[160px] font-bold font-[inherit] inline-block mq900:text-33xl mq900:leading-[96px] mq450:text-13xl mq450:leading-[64px]">
          <span>{`घर बैठे बैठे  `}</span>
          <span className="text-color">ज्योतिष </span>
          <span>सीख</span>
        </h1>
