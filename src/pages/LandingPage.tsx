  ...
  return (
    <div className="w-full relative bg-ppp-white overflow-hidden flex flex-col items-end justify-start pt-14 pb-[125px] pl-[63px] pr-16 box-border gap-11 leading-[normal] tracking-[normal] mq900:gap-[22px] mq1300:pl-[31px] mq1300:pr-8 mq1300:box-border">
      <section className="flex flex-row items-start justify-end py-0 px-9 box-border max-w-full text-left text-5xl text-gray-200 font-outfit">
        <div className="w-full flex flex-col items-start justify-start gap-[33px] max-w-full mq900:gap-4">
          <FrameComponent1 />
          <div className="self-stretch flex flex-row items-start justify-start gap-[73px] max-w-full flex-wrap mq900:gap-9 mq450:gap-[18px]">
            <Testimonial />
            <div className="flex-1 flex flex-col items-start justify-start gap-[42px] min-w-[300px] max-w-full mq900:min-w-full mq450:gap-[21px]">
              <div className="self-stretch relative max-w-full mq900:min-h-[895px]">
                {/* Adjusted Container */}
                <div
                  className="absolute top-[107px] left-[139px] w-[645px] max-w-full overflow-hidden flex flex-row items-start justify-center pt-7 pb-[27px] pl-[21px] pr-5 box-border bg-cover bg-no-repeat bg-[top] z-[1] mq1300:left-[50px] mq900:left-[0px] mq900:w-full"
                  style={{
                ...
                >
                  <div className="w-full max-w-[400px] rounded-[20px] bg-ppp-white border-ppp-grey border-[1px] border-solid box-border flex flex-col items-start justify-start py-[38px] px-[39px] gap-4 mq900:py-[30px] mq900:px-[20px]">
                ...
                <div className="absolute top-0 left-0 w-full h-full">
                  ...
                  {/* Additional stars */}
                  <img
                    className="absolute top-[24px] left-[64px] w-[29px] h-[29px] z-[1] mq900:w-[20px] mq900:h-[20px]"
                    loading="lazy"
                    alt=""
                    src="/star-1.svg"
                  />
                  <img
                    className="absolute top-[194px] left-[79px] w-3.5 h-3.5 z-[1] mq900:w-2.5 mq900:h-2.5"
                    alt=""
                    src="/star-2.svg"
                  />
                  <img
                    className="absolute top-[431px] left-0 w-[58px] h-[58px] z-[1] mq900:w-[40px] mq900:h-[40px]"
                    loading="lazy"
                    alt=""
                    src="/star-4.svg"
                  />
