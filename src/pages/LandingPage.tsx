...
const LandingPage: FunctionComponent = () => {
  return (
    <div className="w-full relative bg-ppp-white overflow-hidden flex flex-col items-end justify-start pt-14 pb-[125px] px-[63px] box-border gap-11 leading-[normal] tracking-[normal] lg:px-[31px] md:px-8 md:gap-[22px]">
      <section className="flex flex-row items-start justify-end py-0 px-9 box-border max-w-full text-left text-5xl text-gray-200 font-outfit md:px-4">
        <div className="w-full flex flex-col items-start justify-start gap-[33px] max-w-full lg:gap-[22px]">
          <FrameComponent1 />
          <div className="self-stretch flex flex-row items-start justify-start gap-[73px] max-w-full flex-wrap lg:gap-9 md:gap-[18px]">
            <Testimonial />
            <div className="flex-1 flex flex-col items-start justify-start gap-[42px] min-w-[300px] max-w-full lg:min-w-[450px] md:min-w-full md:gap-[21px]">
              <div className="self-stretch relative max-w-full lg:min-h-[700px]">
                {/* Adjusted Container */}
                <div
                  className="absolute top-[107px] left-[139px] w-[645px] max-w-full overflow-hidden flex flex-row items-start justify-center pt-7 pb-[27px] pl-[21px] pr-5 box-border bg-cover bg-no-repeat bg-[top] z-[1] lg:left-[50px] md:left-0 md:w-full"
                  style={{
                ...
                >
                  <div className="w-full max-w-[400px] rounded-[20px] bg-ppp-white border-ppp-grey border-[1px] border-solid box-border flex flex-col items-start justify-start py-[38px] px-[39px] gap-4 lg:px-5 md:px-3 md:py-[30px]">
                    <div className="relative font-semibold md:text-lg">
